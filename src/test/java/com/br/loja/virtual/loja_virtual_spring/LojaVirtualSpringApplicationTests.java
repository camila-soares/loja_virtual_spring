...
public class LojaVirtualSpringApplicationTests {
    ...
    @Test
	void testCadastraAcesso() throws Exception {

		String descScesso = "ROLE_ADMINTESTE" + Calendar.getInstance().getTimeInMillis();
		Acesso acesso = new Acesso();
		acesso.setDescricao(descScesso);
		...
		assertEquals(descScesso, acesso.getDescricao());
	...
	public void testRestApiCadastroAcesso() throws Exception {
		...
		Acesso acesso = new Acesso();
		acesso.setDescricao("ROLE_PAUNOCU@" + Calendar.getInstance().getTimeInMillis());
